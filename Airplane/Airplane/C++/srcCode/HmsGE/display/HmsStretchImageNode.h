...
class HMS_DLL CHmsStretchImageNode : public CHmsNode
{
public:
	...
	*/
	static CHmsStretchImageNode* Create();
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsStretchImageNode* Create(const std::string& filename);

	/**
	* Creates a sprite with an image filename and a rect.
	*
	* @param   filename A path to image file, e.g., "scene1/monster.png".
	* @param   rect     The Image Stretch to the Rect.
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsStretchImageNode* Create(const std::string& filename, const Rect& rect);

	static CHmsStretchImageNode* Create(const std::string& filename, const Size& assignedSize);

	static CHmsStretchImageNode* Create(const std::string& filename, float assignedWidth, float assignedHeight);
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsStretchImageNode* CreateWithTexture(Texture2D *texture);
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsStretchImageNode* CreateWithTexture(Texture2D *texture, const Rect& rect, bool rotated = false);
	...
	*/
	static CHmsStretchImageNode* CreateWithSpriteFrame(SpriteFrame *spriteFrame);
	...
	* @return  An auto released sprite object.
	*/
	static CHmsStretchImageNode* CreateWithSpriteFrameName(const std::string& spriteFrameName);
	...
	*/
	virtual void SetTextureRect(const Rect& rect, bool rotated, const Size& assignedSize);
	...
	*/
	virtual void SetTextureOrgRect(const Rect& rect);
	...
	*/
//	inline V3F_C4B_T2F_Quad GetQuad() const { /*return _verts;*/ }
    inline void GetQuad() const
    {
    // do something
    }
...
public:
	CHmsStretchImageNode();
	virtual ~CHmsStretchImageNode();
...
private:
	void UpdateVertsPos(const Size & size);
...
private:
	HMS_DISALLOW_COPY_AND_ASSIGN(CHmsStretchImageNode);
