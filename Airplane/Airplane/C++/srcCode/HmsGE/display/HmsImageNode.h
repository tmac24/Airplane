...
#ifndef __SPRITE_CHmsNode_CCSPRITE_H__
#define __SPRITE_CHmsNode_CCSPRITE_H__
...
class HMS_DLL CHmsImageNode : public CHmsNode
{
public:
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsImageNode* Create(const std::string& filename);
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsImageNode* Create(const std::string& filename, const Rect& rect);
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsImageNode* CreateWithTexture(Texture2D *texture);
	...
	* @return  An auto released Image CHmsNode object.
	*/
	static CHmsImageNode* CreateWithTexture(Texture2D *texture, const Rect& rect, bool rotated = false);
	...
	*/
	static CHmsImageNode* CreateWithSpriteFrame(SpriteFrame *spriteFrame);
	...
	* @return  An auto released sprite object.
	*/
	static CHmsImageNode* CreateWithSpriteFrameName(const std::string& spriteFrameName);

	static CHmsImageNode* CreateColorfulSolidRect(const Size & size, const Color3B & color = Color3B::WHITE);
	static CHmsImageNode* CreateColorfulSolidRect(const Rect & rect, const Color3B & color = Color3B::WHITE);

	static Texture2D * GetDefalutWhiteImageTexture();
...
private:
	HMS_DISALLOW_COPY_AND_ASSIGN(CHmsImageNode);
...
#endif // __SPRITE_CHmsNode_CCSPRITE_H__
