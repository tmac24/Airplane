...
#   if defined(ANDROID_NDK) || (HMS_TARGET_PLATFORM == HMS_PLATFORM_BLACKBERRY)
#   include <stddef.h>
#else
#   include <cstddef>
#endif
...
#if defined(_MSC_VER) && (_MSC_VER >= 1400 ) && (HMS_TARGET_PLATFORM != HMS_PLATFORM_MARMALADE)
...
void XMLPrinter::Print( const char* format, ... )
{
    ...
    if ( _fp ) {
        ...
        // way on windows.
#if defined _MSC_VER && (HMS_TARGET_PLATFORM != HMS_PLATFORM_MARMALADE)
        int len = -1;
        int expand = 1000;
        while ( len < 0 ) {
