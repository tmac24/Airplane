...
#if defined(ANDROID_NDK) || defined(__BORLANDC__) || (HMS_TARGET_PLATFORM == HMS_PLATFORM_BLACKBERRY)
#   include <ctype.h>
#   include <limits.h>
#   include <stdio.h>
#   include <stdlib.h>
...
*/
template< int SIZE >
class HMS_DLL MemPoolT : public MemPool
{
public:
...
*/
class HMS_DLL XMLText : public XMLNode
{
...
/** An XML Comment. */
class HMS_DLL XMLComment : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLComment*	ToComment()					{
...
*/
class HMS_DLL XMLDeclaration : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLDeclaration*	ToDeclaration()					{
...
*/
class HMS_DLL XMLUnknown : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLUnknown*	ToUnknown()					{
...
*/
class HMS_DLL XMLElement : public XMLNode
{
    friend class XMLBase;
    friend class XMLDocument;
public:
...
*/
class HMS_DLL XMLDocument : public XMLNode
{
    friend class XMLElement;
public:
    /// constructor
...
/**
	...
	@endverbatim
*/
class HMS_DLL XMLPrinter : public XMLVisitor
{
public:
