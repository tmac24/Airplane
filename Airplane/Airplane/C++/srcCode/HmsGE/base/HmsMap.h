...
public: 
    ...
    : _data()
    {
        static_assert(std::is_convertible<V, Ref*>::value, "Invalid Type for HmsAviPf::Map<K, V>!");
    ...
    {
        HMSASSERT(object != nullptr, "Object is nullptr!");
        object->retain();
        erase(key);
    ...
    {
        HMSASSERT(position != _data.cend(), "Invalid iterator!");
