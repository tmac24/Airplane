 ...
 */
class HMS_DLL CameraBackgroundBrush : public Ref
{
public:
    /**
 ...
 */
class HMS_DLL CameraBackgroundDepthBrush : public CameraBackgroundBrush
{
public:
    /**
 ...
 */
class HMS_DLL CameraBackgroundColorBrush : public CameraBackgroundDepthBrush
{
public:
    /**
 ...
 */
class HMS_DLL CameraBackgroundSkyBoxBrush : public CameraBackgroundBrush
{
public:
    /**
