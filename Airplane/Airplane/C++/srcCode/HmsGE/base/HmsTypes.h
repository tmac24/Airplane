...
/** @struct V3F_C4B
* A Vec2 with a vertex point, a color 4B.
*/
struct HMS_DLL V3F_C4B
{
	/// vertices (3F)
	Vec3     vertices;            // 12 bytes
 ...
 */
struct HMS_DLL V2F_C4B_T2F_Triangle
{
	V2F_C4B_T2F a;
	V2F_C4B_T2F b;
	V2F_C4B_T2F c;
 ...
 */
struct HMS_DLL V2F_C4B_T2F_Quad
{
    /// bottom left
    V2F_C4B_T2F    bl;
    /// bottom right
 ...
 */
struct HMS_DLL V3F_C4B_T2F_Quad
{
    /// top left
    V3F_C4B_T2F    tl;
    /// bottom left
 ...
 */
struct HMS_DLL V2F_C4F_T2F_Quad
{
    /// bottom left
    V2F_C4F_T2F    bl;
    /// bottom right
 ...
 */
enum class HMS_DLL TextVAlignment
{
    TOP,
    CENTER,
    BOTTOM
 ...
 * @note If any of these enums are edited and/or reordered, update Texture2D.m.
 */
enum class HMS_DLL TextHAlignment
{
    LEFT,
    CENTER,
    RIGHT
 ...
 */
struct HMS_DLL AnimationFrameData
{
    T2F_Quad texCoords;
    float delay;
    Size size;
...
extern const ssize_t HMS_DLL HMS_INVALID_INDEX;
