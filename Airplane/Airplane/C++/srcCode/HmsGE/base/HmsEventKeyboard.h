...
#ifndef __HMSAVIPF_KeyboardEvent__
#define __HMSAVIPF_KeyboardEvent__

#include "base/HmsEvent.h"

NS_HMS_BEGIN

class HMS_DLL EventKeyboard : public CHmsEvent
{
public:
    enum class KeyCode
    {
...
#endif /* defined(__HMSAVIPF_KeyboardEvent__) */
