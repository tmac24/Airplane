...
class HMS_DLL HmsFontFreeType : public HmsFont
{
public:
    static const int DistanceMapSpread;

    static HmsFontFreeType* create(const std::string &fontName, float fontSize, GlyphCollection glyphs,
...
private:
    ...
    HmsFontFreeType(bool distanceFieldEnabled = false, int outline = 0);
    virtual ~HmsFontFreeType();
