...
#define MATH_DEG_TO_RAD_DOUBLE(x)          ((x) * 0.017453292519943295)
/**Util macro for conversion from radians to degrees.*/
#define MATH_RAD_TO_DEG(x)          ((x)* 57.29577951f)
#define MATH_RAD_TO_DEG_DOUBLE(x)          ((x)* 57.29577951308232)
/**
...
#ifdef __cplusplus
	#define NS_HMS_MATH_BEGIN                     namespace HmsAviPf {
    #define NS_HMS_MATH_END                       }
	#define USING_NS_HMS_MATH                     using namespace HmsAviPf
#else
    #define NS_HMS_MATH_BEGIN 
    #define NS_HMS_MATH_END 
    #define USING_NS_HMS_MATH 
#endif
