...
void Mat4::createLookAt(const Vec3& eyePosition, const Vec3& tarGetPoistion, const Vec3& up, Mat4* dst)
{
...
void Mat4::createLookAt(float eyePositionX, float eyePositionY, float eyePositionZ,
                          float tarGetPoistionX, float tarGetPoistionY, float tarGetPoistionZ,
                          float upX, float upY, float upZ, Mat4* dst)
{
    GP_ASSERT(dst);

    Vec3 eye(eyePositionX, eyePositionY, eyePositionZ);
    Vec3 target(tarGetPoistionX, tarGetPoistionY, tarGetPoistionZ);
    Vec3 up(upX, upY, upZ);
    up.normalize();
