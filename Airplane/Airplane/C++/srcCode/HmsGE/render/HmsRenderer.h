...
#ifndef __HMS_RENDERER_H_
#define __HMS_RENDERER_H_
...
public:
	...
	static inline bool UseGlVao(){ return s_bUseGlVao; }
	static void SetUseGlVao(bool bUse){ s_bUseGlVao = bUse; }
