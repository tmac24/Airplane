#ifndef __HMS_TRIANGLES_COMMAND__
#define __HMS_TRIANGLES_COMMAND__
...
*/
class HMS_DLL TrianglesCommand : public RenderCommand
{
public:
...
NS_HMS_END
#endif // defined(__HMS_TRIANGLES_COMMAND__)
