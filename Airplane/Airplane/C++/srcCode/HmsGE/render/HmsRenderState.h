#ifndef __HmsAviPf_libs__CCRenderState__
#define __HmsAviPf_libs__CCRenderState__
 ...
 */
class HMS_DLL RenderState : public Ref
{
...
public:
    ...
    /** Texture that will use in the HMS_Texture0 uniform.
     Added to be backwards compatible. Use Samplers from .material instead.
     */
    void setTexture(Texture2D* texture);

    /** Returns the texture that is going to be used for HMS_Texture0.
     ...
     * RenderState object.
     */
    class HMS_DLL StateBlock : public Ref
    {
...
#endif /* defined(__HmsAviPf_libs__CCRenderState__) */
