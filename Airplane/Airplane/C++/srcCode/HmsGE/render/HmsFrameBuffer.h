#ifndef __HMS_FRAME_BUFFER_H__
#define __HMS_FRAME_BUFFER_H__
...
class HMS_DLL RenderTargetBase : public Ref
{
public:
    enum class Type
    {
...
class HMS_DLL RenderTarget : public RenderTargetBase
{
public:
...
class HMS_DLL RenderTargetRenderBuffer : public RenderTargetBase
{
public:
...
class HMS_DLL RenderTargetDepthStencil : public RenderTargetBase
{
public:
...
class HMS_DLL FrameBuffer : public Ref
{
public:
...
#endif /* defined(__HMS_FRAME_BUFFER_H__) */
