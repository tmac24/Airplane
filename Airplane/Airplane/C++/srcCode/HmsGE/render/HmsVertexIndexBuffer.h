#ifndef __HMS_VERTEX_INDEX_BUFFER_H__
#define __HMS_VERTEX_INDEX_BUFFER_H__
...
*/
class HMS_DLL VertexBuffer : public Ref
{
public:
    /**
...
*/
class HMS_DLL IndexBuffer : public Ref
{
public:
    /**
...
#endif /* __HMS_VERTEX_INDEX_BUFFER_H__*/
