#ifndef __HMS_VERTEX_INDEX_DATA_H__
#define __HMS_VERTEX_INDEX_DATA_H__
...
glVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* ptr).
 ...
 @js NA
*/
struct HMS_DLL VertexStreamAttribute
{
    /**
     Constructor.
     */
...
class HMS_DLL VertexData : public Ref
{
public:
    /**
...
#endif //__HMS_VERTEX_INDEX_DATA_H__
